...
namespace RebuildInstanceLists
{
    internal class Program
    {
        ...
        private static string GetListPath(string installPath, string inputPath)
        {
            ...
            outputPath = Path.ChangeExtension(outputPath, ".instancelist64");
            return outputPath;
        }
        ...
        public static void Main(string[] args)
        {
            ...
            var instance64Hashes = project.LoadListsInstance64Names();
            ...
            for (int i = 0; i < inputPaths.Count; i++)
            {
                ...
                HandleEntries(dbpf.Entries.Select(e => e.Key.Instance).Distinct(),
                              instance64Hashes,
                              tracking,
                              breakdown,
                              outputPath);
